...
| precision study | adapters trained through BF16 vs Q8_0: cosine 0.9998; through Q4_K_M: 0.9926 - measurably different objects, capability-equivalent **on this task's wide-margin decisions**. Not equivalent everywhere: an external 36-prompt boundary probe found a tight-margin case where BF16 and Q8 pick `read_file` and Q4 picks `none`. One case, non-monotonic in bit width, [written up in full](docs/adaptation-engine.md) |
